...
def plot(self,
    ...
    for Reg in regions:
        ...
        target_bands = Reg.target_bands if Reg.target_bands else bands
        ...
        for band in target_bands:
            ...
            x_min, y_min = target_wcs.all_world2pix([[ra_max_reg, dec_min_reg]], 0)[0]
            x_max, y_max = target_wcs.all_world2pix([[ra_min_reg, dec_max_reg]], 0)[0]
    ...
    for P in points:
        ...
        for band in target_bands:
            j = bands.index(band)
            target_wcs = self.images[band].wcs
            x, y = target_wcs.all_world2pix([[coords[0], coords[1]]], 0)[0]
