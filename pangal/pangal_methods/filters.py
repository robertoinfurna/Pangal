...
class Filter:
    ...
    def plot(self, color='r'):
        ...
        units = 'Å'
        w_eff = self.effective_wavelength
        if wl_min > 8000:
...
default_plot_units = {
    'FUV': 'mag_arcsec2', 'NUV': 'mag_arcsec2', 
    'galex_fuv': 'mag_arcsec2', 'galex_nuv': 'mag_arcsec2', 
    ...
    **{f'sdss_{band}': 'mag_arcsec2' for band in ['u', 'g', 'r', 'i', 'z']},
    '2mass_j': 'mag_arcsec2','2mass_h': 'mag_arcsec2', '2mass_ks': 'mag_arcsec2', 
    **{f'wise_w{band}': 'mag_arcsec2' for band in ['1','2','3','4']},
    'spitzer_irac_1': 'MJy_sr','spitzer_irac_2': 'MJy_sr', 'spitzer_irac_3': 'MJy_sr', 'spitzer_irac_4': 'MJy_sr',
    'herschel_pacs_70um': 'MJy_sr', 'herschel_pacs_100um': 'MJy_sr', 'herschel_pacs_160um': 'MJy_sr'
}
